...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel,SocketChannel> {
    ...
    protected void initServerSocket() throws Exception {
        ...
        // 设置成阻塞模式，即以阻塞的⽅式接收连接的。
        // ServerSocketChannel通过accept()接受新的连接，accept()⽅法返回获得SocketChannel对象，然后将SocketChannel对象封装在⼀个PollerEvent对象中，
        // 并将PollerEvent对象压⼊Poller的Queue⾥，这是个典型的“⽣产者-消费者”模式，Acceptor与Poller线程之间通过Queue通信。
